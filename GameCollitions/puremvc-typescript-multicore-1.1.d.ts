...
declare namespace puremvc {
     ...
     * order to communicate with one another using <code>INotification</code>s.
     */
    class Notification<T> implements INotification {
        /**
...
declare namespace puremvc {
     ...
     */
    class Mediator<T> extends Notifier implements IMediator, INotifier {
        /**
...
declare namespace puremvc {
     ...
     * data.
     */
    class Proxy<T> extends Notifier implements IProxy, INotifier {
        /**
         ...
         *
         * @param proxyName
         * 		The name of the <code>Proxy</code> instance.T
         *
         * @param data
        ...
        setData(data: T): void;
        /**
         * Get the data of the <code>Proxy></code> instance.T
         *
         * @return
